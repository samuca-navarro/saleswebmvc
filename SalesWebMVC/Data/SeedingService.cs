...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMVCContext context)   //cria um método construtor fazendo injeção de dependência do SalesWebMVCContext 
        {
            _context = context;  //iguala a variável ao q é recebido
        }
